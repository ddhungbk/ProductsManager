...
public class CellStringEditable<S, T> extends TableCell<S, T> {
	...
	public static <S, T> Callback<TableColumn<S, T>, TableCell<S, T>> forTableColumn(
		...
		return list -> new CellStringEditable<S, T>(converter);
	}
	 ...
	 *            T.
	 */
	public CellStringEditable(StringConverter<T> converter) {
