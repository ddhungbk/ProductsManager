...
public class CellDoubleEditable<S, T> extends TableCell<S, T> {
	...
	public static <S, T> Callback<TableColumn<S, T>, TableCell<S, T>> forTableColumn(
		...
		return list -> new CellDoubleEditable<S, T>(converter);
	}
	 ...
	 *            T.
	 */
	public CellDoubleEditable(StringConverter<T> converter) {
